...
int al_contains(ArrayList* this, void* pElement)
{
    ...
    if(this!=NULL&&pElement!=NULL)
    {
        for(i=0;i<this->size;i++)
        {
            ...
            if(i==(this->size-1)&&this->pElements+i!=pElement)
            {
                returnAux=0;
            }
        }
...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if(this!=NULL)
    {
        ...
        for(i=0;i<this->size;i++)
        {
            aux=returnAux->add(returnAux, *(this->pElements+i));
            if(aux==-1)
            {
                returnAux=NULL;
                break;
    ...
    if(this!=NULL&&this2!=NULL)
    {
        ...
        else
        {
            ...
            for(i=0; i<this->size;i++)
            {
                ...
                if(i==this->size-1&&*(this->pElements+i)==*(this2->pElements+i))
                        returnAux=1;
            }
        }
...
int al_sort(ArrayList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this!=NULL && (order==1||order==0) && (*pFunc)!=NULL)
    {
        ...
        for(i=0;i<this->size-1;i++)
        {
            ...
            {
                ordenador=pFunc(al_get(this,i),al_get(this,j));
                if(order==1)
                {
                    switch(ordenador)
                    {
...
int resizeUp(ArrayList* this)
{
    ...
    void** auxReall;
            ...
            auxReall=realloc(this->pElements, sizeof(this->pElements) * (this->reservedSize + AL_INCREMENT));
            if(auxReall!=NULL)
            {
                this->pElements=auxReall;
